...
class ccew_donation_Widget extends \Elementor\Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		parent::__construct( $data, $args );
		 ...
		 wp_register_style( 'ccewd-donation-style', CCEW_URL . 'donation-box/assets/css/ccew-donation-style.css', array() );
		 wp_register_script('ccew-etherjs', CCEW_URL . 'donation-box/assets/js/ethers-5.2.umd.min.js', array('elementor-frontend'), null, true);

		  wp_register_script( 'ccew-custom', CCEW_URL . 'donation-box/assets/js/ccewd-custom.js', array( 'elementor-frontend' ), null, true );
		 wp_register_script( 'ccew-sweetalert2', CCEW_URL . 'donation-box/assets/js/sweetalert2.js', array( 'elementor-frontend' ), null, true );
		 wp_register_script( 'ccew-metamask', CCEW_URL . 'donation-box/assets/js/ccew-metamask.js', array( 'elementor-frontend' ), null, true );
		 wp_register_script( 'ccew-clipboard', CCEW_URL . 'donation-box/assets/js/clipboard.min.js', array( 'elementor-frontend' ), null, true );
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'ccewd_coin_list',
			array(
				'label'       => __( 'Slect Coins', 'plugin-domain' ),
