...
class ccew__Widget extends \Elementor\Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'ccew-card', CCEW_URL . '/assets/css/ccew-card.css', array() );
		wp_register_style( 'ccew-label', CCEW_URL . '/assets/css/ccew-label.min.css', array() );
		wp_register_style( 'ccew-common-styles', CCEW_URL . '/assets/css/ccew-common-styles.css', array() );
		wp_register_style( 'ccew-icons-style', CCEW_URL . 'assets/css/ccew-icons.min.css', array() );
		wp_register_style( 'ccew-list-style', CCEW_URL . '/assets/css/ccew-list.css ', array() );
		wp_register_style( 'ccew-custom-datatable-style', CCEW_URL . 'assets/css/ccew-custom-datatable.css', array() );
		wp_register_script( 'ccew-anychart-core', CCEW_URL . 'assets/js/ccew-anychart-core.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-anychart-sparkline', CCEW_URL . 'assets/js/ccew-anychart-sparkline.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-anychart-area', CCEW_URL . 'assets/js/ccew-anychart-area.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'small-chart', CCEW_URL . 'assets/js/small-chart.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-call-ajax', CCEW_URL . 'assets/js/ccew-call-ajax.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-numeral', CCEW_URL . 'assets/js/numeral.min.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-table-sort', CCEW_URL . 'assets/js/tablesort.min.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-datatable', CCEW_URL . 'assets/js/jquery.dataTables.min.js', array( 'elementor-frontend' ), null, true );
		wp_register_script( 'ccew-headFixer', CCEW_URL . 'assets/js/tableHeadFixer.js', array( 'elementor-frontend' ), null, true );
	...
	protected function register_controls() {
        ...
        <div class="ccew_logo_container"><a href="https://wordpress.org/plugins/cryptocurrency-widgets-for-elementor/#reviews" target="_blank"><img src="' . CCEW_URL . 'assets/images/ccew-logo.png" alt="Cryptocurrency widget for elementor" style="max-width:80px;"></a></div>
        <div class="ccew_cmc_def">You have been using <a href="https://wordpress.org/plugins/cryptocurrency-widgets-for-elementor/#reviews" target="_blank">Cryptocurrency Widgets For Elementor</a>
       for a while. We hope you liked it ! Please give us a quick rating, it works as a boost for us to keep working on the plugin !</div>
		<div class="ccew_link_wrap"><a class="ccew_demo_link" href="https://wordpress.org/plugins/cryptocurrency-widgets-for-elementor/#reviews" target="_blank"><button class="ccew-custom-primry-btn">Submit Review ★★★★★</button></a></div>
				...
				array(
					...
					'raw'        => '<ul class="ccew-permotion-plugins">
							<div class="ccew_cmc_demo">
							 <div class="ccew_logo_container"><a href="https://wordpress.org/plugins/cryptocurrency-widgets-for-elementor/#reviews" target="_blank"><img src="' . CCEW_URL . 'assets/images/coinmarketcap-logo.png" alt="Cryptocurrency widget for elementor" style="max-width:80px;"></a></div>
							...
							</div><div class="ccew_link_wrap"><a class="ccew_demo_link" href="https://cryptocurrencyplugins.com/demo/#coins-marketcap" target="_blank"><button class="ccew-custom-primry-btn">View Demos </button> </a> <a class="ccew_demo_buyk" href="https://codecanyon.net/item/coin-market-cap-prices-wordpress-cryptocurrency-plugin/21429844?irgwc=1&clickid=QiDSf%3AwR6xyOW95wUx0Mo3QwUkBWLPxbCTTmxE0&iradid=275988&irpid=1258464&iradtype=ONLINE_TRACKING_LINK&irmptype=mediapartner&mp_value1=&utm_campaign=af_impact_radius_1258464&utm_medium=affiliate&utm_source=impact_radius" target="_blank"><button class="ccew-custom-primry-btn">Buy Pro</button></a></div>
							</div>
							<hr>
							<div class="ccew_cmc_demo">
							<div class="ccew_logo_container"><a href="https://wordpress.org/plugins/cryptocurrency-widgets-for-elementor/#reviews" target="_blank"><img src="' . CCEW_URL . 'assets/images/crypto-widget-pro.png" alt="Cryptocurrency widget for elementor" style="max-width:80px;"></a></div>
							<div class="ccew_cmc_def"><strong>Cryptocurrency Widgets Pro</strong>
							Show cryptocurrency price table, historical charts, tickers and other widgets inside any page or post.</div><div class="ccew_link_wrap"><a class="ccew_demo_link" href="https://cryptocurrencyplugins.com/demo/#cryptocurrency-widgets-pro" target="_blank"><button class="ccew-custom-primry-btn">View Demos </button> </a><a class="ccew_demo_buyk"  href="https://codecanyon.net/item/cryptocurrency-price-ticker-widget-pro-wordpress-plugin/21269050?irgwc=1&clickid=QiDSf%3AwR6xyOW95wUx0Mo3QwUkBWLNQDCTTmxE0&iradid=275988&irpid=1258464&iradtype=ONLINE_TRACKING_LINK&irmptype=mediapartner&mp_value1=&utm_campaign=af_impact_radius_1258464&utm_medium=affiliate&utm_source=impact_radius" target="_blank"><button class="ccew-custom-primry-btn">Buy Pro</button></a></div>
							</div>			
						  </ul>',
	...
	protected function render() {
		...
		if ( isset( $html_setting['required_coins'] ) && $html_setting['required_coins'] == '' && $settings['ccew_widget_type'] == 'advanced_table' ) {
			...
			<th data-classes="ccew_coin_total_volume" data-index="total_volume">' . esc_html__( 'Volume', 'ccew' ) . '</th>
			<th data-classes="ccew_coin_supply" data-index="supply">' . esc_html__( 'Supply', 'ccew' ) . '</th>
			</tr></thead><tbody>
			</tbody><tfoot>
			</tfoot></table>
			</div>
